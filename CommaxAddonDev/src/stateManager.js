...
function createInitialState() {
    return {
        ...
        lifeInfoState: {
            ...
            lifeInfoCurrentWeatherDiscoveryVersion: 0,
            lifeInfoOutdoorPm10Discovered: false,
            lifeInfoForecastDiscovered: false,
            lifeInfoForecastDiscoveryVersion: 0,
...
function normalizeState(raw = {}) {
    ...
    return {
        ...
        lifeInfoState: {
            ...
            lifeInfoCurrentWeatherDiscovered: raw.lifeInfoState?.lifeInfoCurrentWeatherDiscovered || false,
            lifeInfoCurrentWeatherDiscoveryVersion: raw.lifeInfoState?.lifeInfoCurrentWeatherDiscoveryVersion || 0,
            lifeInfoOutdoorPm10Discovered: raw.lifeInfoState?.lifeInfoOutdoorPm10Discovered || false,
            lifeInfoForecastDiscovered: raw.lifeInfoState?.lifeInfoForecastDiscovered || false,
            lifeInfoForecastDiscoveryVersion: raw.lifeInfoState?.lifeInfoForecastDiscoveryVersion || 0,
...
function serializeState(state) {
    return {
        ...
        lifeInfoState: {
            ...
            lifeInfoCurrentWeatherDiscovered: state.lifeInfoState.lifeInfoCurrentWeatherDiscovered || false,
            lifeInfoCurrentWeatherDiscoveryVersion: state.lifeInfoState.lifeInfoCurrentWeatherDiscoveryVersion || 0,
            lifeInfoOutdoorPm10Discovered: state.lifeInfoState.lifeInfoOutdoorPm10Discovered || false,
            lifeInfoForecastDiscovered: state.lifeInfoState.lifeInfoForecastDiscovered || false,
            lifeInfoForecastDiscoveryVersion: state.lifeInfoState.lifeInfoForecastDiscoveryVersion || 0,
